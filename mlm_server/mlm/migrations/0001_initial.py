    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus_type', models.CharField(choices=[('green_1', 'Зеленый бонус (1-й партнер)'), ('green_2', 'Зеленый бонус (2-й партнер)'), ('red', 'Красный бонус')], max_length=20, verbose_name='Тип бонуса')),
